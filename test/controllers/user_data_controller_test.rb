...
class UserDataControllerTest < ActionController::TestCase
  ...
  test "should create user_datum" do
    assert_difference('UserDatum.count') do
      post :create, user_datum: { user_agent_string: @user_datum.user_agent_string, window_size: @user_datum.window_size }
    end
  ...
  test "should update user_datum" do
    patch :update, id: @user_datum, user_datum: { user_agent_string: @user_datum.user_agent_string, window_size: @user_datum.window_size }
    assert_redirected_to user_datum_path(assigns(:user_datum))
  end
